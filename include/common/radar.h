...
public:
    ...
    {
      //std::cout << "Cleaning coordinates "  << std::endl;
      coords.clear();
      //std::cout << "Cleaning coordinates DONE"  << std::endl;

    {
      //std::cout << "Reserving space for coordinates "  << std::endl;      
      coords.reserve(numDetObj_int);
      //std::cout << "Reserving space for coordinates DONE "  << std::endl;      
      ...
      //std::cout << "Appending elements DONE"  << std::endl;      
