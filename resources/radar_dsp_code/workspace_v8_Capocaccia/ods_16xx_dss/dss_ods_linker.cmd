...
SECTIONS
{
    ...
    */ 
    ...
    .fastCode: 
    {
        ...
        mathlib.ae674(.text)
        dss_data_path.oe674 (.text:OdsDemo_interFrameProcessing)
        /*dss_data_path.oe674 (.text:OdsDemo_processChirp)*/
        dss_data_path.oe674 (.text:OdsDemo_interChirpProcessing)
        dss_data_path.oe674 (.text:OdsDemo_angleEstimationAzimElev)
        dss_data_path.oe674 (.text:OdsDemo_cfarPeakGrouping)
        //dss_data_path.oe674 (.text:OdsDemo_cfarPeakGroupingCfarQualified)
        //dss_main.oe674 (.text:OdsDemo_dssDataPathProcessEvents)
    } load=L3SRAM PAGE 0, run=L1PSRAM PAGE 0, table(_OdsDemo_fastCode_L1PSRAM_copy_table, compression=off)
    ...
    .overlay:
    {
        ...
        dss_main.oe674 (.text:OdsDemo_dssInitTask)
        dss_main.oe674 (.text:main)
        dss_data_path.oe674 (.text:OdsDemo_dataPathInitEdma)
    } > L3SRAM PAGE 0
